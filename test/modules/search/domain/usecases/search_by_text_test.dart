...
import 'package:github_search_arq/modules/search/domain/repositories/search_repository.dart';
...
main() {
  ...
  test('Deve retornar um InvalidTextError caso o texto seja invalido',
    ...
    // expect(result.fold((l) => l, (r) => r), isA<InvalidTextError>()); // mesmo que abaixo
